...
for index, line in enumerate(lines):
    if line.startswith("globalTimeLimit="):
        lines[index] = "globalTimeLimit=14400\n"
    elif line.startswith("timeLimit="):
        lines[index] = "timeLimit=14400\n"
                                                                        ...
                                                                        if form == '2':
                                                                            for tflow in TFlowSet:
                                                                                ...
                                                                                if (gen == "0" and tflow not in tflowAlreadyDone0) or (gen=="1"):
                                                                                    ...
                                                                                    if gnpy == '1':
                                                                                        qotFolder = "../Outputs/QoTSet" + "/oP" +auxLinkStrategy+ auxTransponderStrategy+ "_i" + topology + "_d" + demandCode + "_of" + obj + "_f" + form + "_tf" + tflow+ "_cd" + cd + "_os" + osnr + "_gn" + gnpy+ "_b" + band + "_r" + "0" + "_cu" + cut+ "_p" + prepro+"_g"+gen+"_it"+iterationsXPop[0]+"_p"+iterationsXPop[1]+"_c"+crossingXmut[0]+"_m"+crossingXmut[1]+"_cK"+ks[0]+"_eK"+ks[1]+"_lb"+lb+"_cp"+cplex
                                                                                        #os.mkdir(qotFolder)
                                                                                        #print(qotFolder)
                                                                            ...
                                                                            if (gen == "0" and firstPassage == "0") or (gen=="1"):
                                                                                ...
                                                                                if gnpy == '1':
                                                                                    qotFolder = "../Outputs/QoTSet" + "/oP" +auxLinkStrategy+ auxTransponderStrategy+ "_i" + topology + "_d" + demandCode + "_of" + obj + "_f" + form + "_cd" + cd + "_os" + osnr + "_gn" + gnpy+ "_b" + band + "_r" + "0" + "_cu" + cut+ "_p" + prepro+"_g"+gen+"_it"+iterationsXPop[0]+"_p"+iterationsXPop[1]+"_c"+crossingXmut[0]+"_m"+crossingXmut[1]+"_cK"+ks[0]+"_eK"+ks[1]+"_lb"+lb+"_cp"+cplex
                                                                                    #os.mkdir(qotFolder)
                                                                                    #print(qotFolder)
                                                                                    shutil.copytree("../Inputs/QoT_ReferenceFolder", qotFolder)  
                                                                                    thisQotFolderDemands = [f.name for f in os.scandir(qotFolder+"/demands") if f.is_file()]
...
for element in toClean:
    if element.startswith(("jobsbatch_", "SB_jobsbatch_", "MB_jobsbatch_")):
...
for batch in batchsList:
    ...
    with open("../Inputs/jobsBase.sh", newline='') as jobsFile: 
        ...
        for row in aux:
            jobsRows.append(row)
        f.close() 
    jobsName = "../Outputs/MB_jobs" + batch + ".sh"
...
with open("../Outputs/script.sh", "w") as f:
    for batch in batchsList:
        stringLine = "sbatch " + "MB_jobs" + batch + ".sh\n"
        f.write(stringLine)
        stringLine2 = "echo " + "MB_jobs" + batch + ".sh "+ ">> okBatchs.txt\n"
        f.write(stringLine2)
f.close() 
