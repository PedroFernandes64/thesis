...
class MainWindow(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.GNModel_activation = StringVar()
    ...
    def create_param(self):
        ...
        if self.topologyFile.get() != '':
            ...
            os.system("-a " + self.topologyFile.get() + " > topologyFile.txt")
        ...
        file.write('******* GNModel parameters *******\n')
        
        if self.GNModel_activation.get() == "Deactivated":
            file.write('GNModel_activation=0\n')
        else:   
            file.write('GNModel_activation=1\n')
    ...
    def imp_param(self):
        ...
        os.system("" + self.paramFileFolder.get())
    ...
    def gen_param(self):
        ...
        os.system("onlineParameters.txt")
